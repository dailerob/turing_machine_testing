"""V2: GDC-TS (absorb mode) on 1-step diffs for M4 monthly."""
...
def gdc_diff_forecast(train, window_len=12, sigma_frac=0.50,
                      alpha=0.99, theta=0.0, h=HORIZON):
    n = len(train)
    if n < window_len + h + 2:
...
def main():
    ...
    print(f"\n=== Top 10 GDC-diff configs by mean ===")
